...
6.https://www.tianyancha.com/usercenter/business是购买企业用户的账号访问页面
"""
...
with open("D:\pycharm\workspace\python\online_check\data\web.txt", "r") as f:
    for i in f:
        url = i.strip()
        ...
        c.setopt(pycurl.HTTPHEADER, [
            "cookie:aliyungf_tc=AQAAAALXdkmEEg4Ahi702nTL1zm9IJ29; csrfToken=sVRBXAg2VEoM-oOJEv7rlOGV; "
            ...
            "Hm_lpvt_e92c8d65d92d534b0fc290df538b4758=1524907827"]) 
        ...
        if c.getinfo(pycurl.HTTP_CODE) == 200 and len(t.contents) > 6500:
            print c.getinfo(pycurl.HTTP_CODE), c.getinfo(pycurl.EFFECTIVE_URL)
            c.close()
            print  duration  # 'pycurl takes %s seconds to get %s ' % (duration, url)
            print 'lenth of the content is %d' % len(t.contents)
        else:
            print c.getinfo(pycurl.HTTP_CODE), "\033[1;31;40m %s is false!\033[0m" % url
